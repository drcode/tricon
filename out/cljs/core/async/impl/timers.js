...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3954__auto__,writer__3955__auto__,opt__3956__auto__){return cljs.core._write.call(null,writer__3955__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_17517 = 0;while(true){
if((i_17517 < arr.length))
{(arr[i_17517] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3954__auto__,writer__3955__auto__,opt__3956__auto__){return cljs.core._write.call(null,writer__3955__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_17524 = (self__.level + 1);while(true){
if((i_17524 <= (new_level + 1)))
{(update[i_17524] = self__.header);
{
var G__17525 = (i_17524 + 1);
i_17524 = G__17525;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17526 = 0;while(true){
if((i_17526 <= self__.level))
{var links_17527 = (update[i_17526]).forward;if(((links_17527[i_17526]) === x__$1))
{(links_17527[i_17526] = (x__$1.forward[i_17526]));
{
var G__17528 = (i_17526 + 1);
i_17526 = G__17528;
continue;
}
} else
{{
var G__17529 = (i_17526 + 1);
i_17526 = G__17529;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3405__auto__ = (cljs.core.truth_((function (){var and__3393__auto__ = me;if(cljs.core.truth_(and__3393__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3393__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3405__auto__))

...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t17558 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t17558 = (function (val,box,meta17559){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t17558.cljs$lang$type = true;
cljs.core.async.impl.channels.t17558.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t17558";
cljs.core.async.impl.channels.t17558.cljs$lang$ctorPrWriter = (function (this__3954__auto__,writer__3955__auto__,opt__3956__auto__){return cljs.core._write.call(null,writer__3955__auto__,"cljs.core.async.impl.channels/t17558");
});
cljs.core.async.impl.channels.t17558.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t17558.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17560){var self__ = this;
var _17560__$1 = this;return self__.meta17559;
});
cljs.core.async.impl.channels.t17558.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17560,meta17559__$1){var self__ = this;
var _17560__$1 = this;return (new cljs.core.async.impl.channels.t17558(self__.val,self__.box,meta17559__$1));
});
cljs.core.async.impl.channels.__GT_t17558 = (function __GT_t17558(val__$1,box__$1,meta17559){return (new cljs.core.async.impl.channels.t17558(val__$1,box__$1,meta17559));
});
}
return (new cljs.core.async.impl.channels.t17558(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3957__auto__,writer__3958__auto__,opts__3959__auto__){return cljs.core._write.call(null,writer__3958__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3954__auto__,writer__3955__auto__,opt__3956__auto__){return cljs.core._write.call(null,writer__3955__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_17561 = self__.takes.pop();if((taker_17561 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_17561))
{var take_cb_17562 = cljs.core.async.impl.protocols.commit.call(null,taker_17561);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_17562,taker_17561){
return (function (){return take_cb_17562.call(null,null);
});})(take_cb_17562,taker_17561))
);
} else
{}
{

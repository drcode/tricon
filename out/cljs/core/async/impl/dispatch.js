...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17552 = 0;while(true){
var m_17553 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17553 == null))
{} else
{m_17553.call(null);
if((count_17552 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17554 = (count_17552 + 1);
count_17552 = G__17554;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3393__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3393__auto__)
